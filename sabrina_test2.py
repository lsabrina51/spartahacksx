...
# Function to save GPT response as MP3 file using Google Cloud Text-to-Speech and play it automatically
...
# Function to play the MP3 file automatically
...
def process_speech_to_gpt():
    ...
    while True:
        ...
        if transcription:
            ...
            # Step 6: Save the GPT response as an MP3 file and automatically play it
